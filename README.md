...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C167%20rows-8250df">
...
**Public extract:** 8,167 rows · **Live catalog:** 8,166 domains
...
- `land.csv` — public CSV extract (8,167 rows)
- `land.json` — public JSON extract (8,167 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,167-row public sample | 8,166 live domains                               |
